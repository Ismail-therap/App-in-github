...
combining_tz<-function(shifted_merged="folder"){
  shifted_merged<-shifted_merged[,-c(3,8,13,18,23,28)]
  #head(shifted_merged)
...
#write.csv(shifted,"data/combined_tz_all_moudule_shifted.csv")
#not_shifted<-combining_tz((multmerge("data/not shifted")))
#write.csv(not_shifted,"data/combined_tz_all_moudule_notshifted.csv")
